...
import { MediaQueryType, ViewType } from './types';

export const ViewTheme = ({ direction, reverse, gap, crossGap, border, borderRadius, axis, ...props }: ViewType) => {
...
export const extandedMediaQuery = ({ _mediaQuery }: MediaQueryType) => {
  const mq_theme = () => {
    if (_mediaQuery) {
      return {
        s1440: {
          ...(ViewTheme(_mediaQuery.s1440 || {}) as any),
          '&:hover': ViewTheme(_mediaQuery.s1440?._hover || {}) as any,
          '&:active': ViewTheme(_mediaQuery.s1440?._active || {}) as any,
        },
        s1280: {
          ...(ViewTheme(_mediaQuery.s1280 || {}) as any),
          '&:hover': ViewTheme(_mediaQuery.s1280?._hover || {}) as any,
          '&:active': ViewTheme(_mediaQuery.s1280?._active || {}) as any,
        },
        s1080: {
          ...(ViewTheme(_mediaQuery.s1080 || {}) as any),
          '&:hover': ViewTheme(_mediaQuery.s1080?._hover || {}) as any,
          '&:active': ViewTheme(_mediaQuery.s1080?._active || {}) as any,
        },
        s768: {
          ...(ViewTheme(_mediaQuery.s768 || {}) as any),
          '&:hover': ViewTheme(_mediaQuery.s768?._hover || {}) as any,
          '&:active': ViewTheme(_mediaQuery.s768?._active || {}) as any,
        },
        s600: {
          ...(ViewTheme(_mediaQuery.s600 || {}) as any),
          '&:hover': ViewTheme(_mediaQuery.s600?._hover || {}) as any,
          '&:active': ViewTheme(_mediaQuery.s600?._active || {}) as any,
        },
        s428: {
          ...(ViewTheme(_mediaQuery.s428 || {}) as any),
          '&:hover': ViewTheme(_mediaQuery.s428?._hover || {}) as any,
          '&:active': ViewTheme(_mediaQuery.s428?._active || {}) as any,
        },
      };
    }
  };
